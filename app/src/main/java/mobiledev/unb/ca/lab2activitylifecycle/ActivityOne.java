...
public class ActivityOne extends Activity {
    ...
    private TextView onCreateText = (TextView) findViewById(R.id.onCreate);
    private TextView onStartText = (TextView) findViewById(R.id.onStart);
    private TextView onResumeText = (TextView) findViewById(R.id.onResume);
    private TextView onRestartText = (TextView) findViewById(R.id.onRestart);
